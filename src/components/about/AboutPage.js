...
class AboutPage extends Component {
  render() {
    return (
      <div>
        <h1>About Us</h1>
        <p>This is a food deliverly platform where you make an order and food is delivered to your doorstep. Go to the food menu and order some food.</p>
        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. 
          ...
          I should be incapable of drawing a single stroke at the present moment; and yet I feel that I never was a greater artist than now.
           ...
           countless indescribable forms of the insects and flies, then I feel the presence of the Almighty, who formed us in his own image, and the breath</p>
      </div>
    );
  }
}
